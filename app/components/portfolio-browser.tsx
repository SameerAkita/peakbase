    ...
    <main className="mx-auto flex min-h-screen w-full max-w-7xl flex-1 flex-col gap-6 p-4 sm:p-6 lg:p-8">
      ...
      {activeTab.id === "overview" ? (
        ...
        <section className="panel p-5">
          <h2 className="text-base font-semibold text-zinc-950">Current Holdings</h2>
          <p className="mt-2 text-sm text-[var(--text-soft)]">
            Holdings table content can be added here next. This shell is set up so we can plug in real rows and filters without changing the page structure.
          </p>
